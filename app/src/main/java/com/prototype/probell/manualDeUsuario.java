...
public class manualDeUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Llama al diálogo correspondiente y para mostrar el logo y significado de pausar
        inf7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), dialogosManual.class);
                intent.putExtra("numDialogo", "7");
                startActivityForResult(intent,7);
            }
        });

        //Llama al diálogo correspondiente y para mostrar el logo y significado de reanudar
        inf8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), dialogosManual.class);
                intent.putExtra("numDialogo", "8");
    ...
    private void buscarIDs(){
        ...
        inf1 = (Button) findViewById(R.id.desplegarm1);
        inf2 = (Button) findViewById(R.id.desplegarm2);
        inf4 = (Button) findViewById(R.id.desplegarm4);
        inf5 = (Button) findViewById(R.id.desplegarm5);
        inf6 = (Button) findViewById(R.id.desplegarm6);
        inf7 = (Button) findViewById(R.id.desplegarm7);
        inf8 = (Button) findViewById(R.id.desplegarm8);
        inf9 = (Button) findViewById(R.id.desplegarm9);
        inf10 = (Button) findViewById(R.id.desplegarm10);
        inf11 = (Button) findViewById(R.id.desplegarm11);
        inf12 = (Button) findViewById(R.id.desplegarm12);
        inf13 = (Button) findViewById(R.id.desplegarm13);
        inf14 = (Button) findViewById(R.id.desplegarm14);
        inf15 = (Button) findViewById(R.id.desplegarm15);
        inf16 = (Button) findViewById(R.id.desplegarm16);
    }
}