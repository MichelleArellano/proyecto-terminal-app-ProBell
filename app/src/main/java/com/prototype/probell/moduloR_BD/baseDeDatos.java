package com.prototype.probell.moduloR_BD;
...
public class baseDeDatos extends SQLiteOpenHelper {
    ...
    public static String BASE_NAME = "moduloR.db";
    ...
    public Cursor obtenerTablaID(String tabla,String idTabla,String idBuscado){
        SQLiteDatabase db = this.getReadableDatabase();
