...
public class menuPrincipal extends AppCompatActivity {
    ...
    private void buscarIDs(){
        rutinas = (CardView) findViewById(R.id.cardRutinas);
        rutinaSeleccionada = (CardView) findViewById(R.id.cardRutinaSeleccionada);
        manual = (CardView) findViewById(R.id.cardManual);
    }
}