...
import com.prototype.probell.moduloR_BD.baseDeDatos;
import com.prototype.probell.moduloR_BD.hemisferio;
import com.prototype.probell.moduloR_BD.rutinas;
import com.prototype.probell.moduloR_BD.tiempo;
import com.prototype.probell.moduloR_BD.velocidad;
import com.prototype.probell.moduloR_BD.zona;
...
public class seleccionDeRutina extends AppCompatActivity {
    ...
    public seleccionDeRutina() {
        ...
        setTipo("1");
        estatusMR = 0;
        moduloRPath = "/data/data/com.prototype.probell/databases/moduloR.db";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mR = new baseDeDatos(getApplicationContext(), "moduloR.db",null,1); //Conexion a la base de datos
    ...
    private void consultarMRTiem(){
        ...
        //Select * from tiempo
        Cursor cursor = mR.obtenerTablaCompleta(baseDeDatos.tiempo.TABLA_tiempo);
    ...
    private void consultarMRVel(){
        ...
        Cursor cursor = mR.obtenerTablaCompleta(baseDeDatos.velocidad.TABLA_velocidad);
    ...
    private void consultarMRZonas(){
       Cursor czona1, czona2, czona3;
        czona1 = mR.obtenerZonas(baseDeDatos.zona.TABLA_zona,baseDeDatos.zona.COL_ID_ZONA,String.valueOf(1));
        czona2 = mR.obtenerZonas(baseDeDatos.zona.TABLA_zona,baseDeDatos.zona.COL_ID_ZONA,String.valueOf(2));
        czona3 = mR.obtenerZonas(baseDeDatos.zona.TABLA_zona,baseDeDatos.zona.COL_ID_ZONA,String.valueOf(3));
        ...
        czona1 = mR.obtenerDetallesZona(baseDeDatos.zona.TABLA_zona,baseDeDatos.zona.COL_ID_ZONA,String.valueOf(1));
        czona2 = mR.obtenerDetallesZona(baseDeDatos.zona.TABLA_zona,baseDeDatos.zona.COL_ID_ZONA,String.valueOf(2));
        czona3 = mR.obtenerDetallesZona(baseDeDatos.zona.TABLA_zona,baseDeDatos.zona.COL_ID_ZONA,String.valueOf(3));
    ...
    private  void consultarHemisferiosMR(){
        ...
        cursorDerecho = mR.obtenerTablaID(baseDeDatos.hemisferio.TABLA_hemisferio,baseDeDatos.hemisferio.COL_ID_HEMISFERIO,String.valueOf(1)); //Derecho 1
        cursorIzquierdo = mR.obtenerTablaID(baseDeDatos.hemisferio.TABLA_hemisferio,baseDeDatos.hemisferio.COL_ID_HEMISFERIO,String.valueOf(2)); //Izquierdo 2
    ...
    private void moduloRutinas() {
        int estatusBDMR;
        baseDeDatos mR = new baseDeDatos(getApplicationContext(), "moduloR.db",null,1);
    ...
    private void buscarIDs(){
        ...
        iniRut = (Button) findViewById(R.id.btIniRut);
        regresar = (Button) findViewById(R.id.btRegresar);
        grupoHemisferiosC = (RadioGroup) findViewById(R.id.radioGroupHC);
        hemisferioIzqC = (RadioButton) findViewById(R.id.rgIzqC);
        hemisferioDerC = (RadioButton) findViewById(R.id.rgDerC);
        tiempoZonasC = (Spinner) findViewById(R.id.spTiemRC);
        velocidadZonasC = (Spinner) findViewById(R.id.spVelRC);
        grupoHemisferiosZ = (RadioGroup) findViewById(R.id.radioGroupHZ);
        hemisferioIzqZ = (RadioButton) findViewById(R.id.rgIzqZ);
        hemisferioDerZ = (RadioButton) findViewById(R.id.rgDerZ);
        tiempoZonasZ = (Spinner) findViewById(R.id.spTiemRZ);
        velocidadZonasZ = (Spinner) findViewById(R.id.spVelRZ);
        zona1 = (CheckBox) findViewById(R.id.cbzona1);
        zona2 = (CheckBox) findViewById(R.id.cbzona2);
        zona3 = (CheckBox) findViewById(R.id.cbzona3);
        z1T = (TextView) findViewById(R.id.txtTXTzona1);
        z2T = (TextView) findViewById(R.id.txtTXTzona2);
        z3T = (TextView) findViewById(R.id.txtTXTzona3);
        z1DT = (TextView) findViewById(R.id.txtdescripcion1);
        z2DT = (TextView) findViewById(R.id.txtdescripcion2);
        z3DT = (TextView) findViewById(R.id.txtdescripcion3);
    }
