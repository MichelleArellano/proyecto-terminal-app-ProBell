...
public class dialogosManual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Textos
        //----------------------------------------------------------------------Menu
        String DesRutDisponibles = null,DesSeleccionarRutina=null;
        ...
        //----------------------------------------------------------------------Botones
        String DesPruebaDeMotores = null,DesPruebaDeMotores1=null;
        ...
        String DesConexionBlue = null,DesConexionBlue1=null;
        ...
        String DesControles = null,DesControles1=null,DesControles2=null,DesControles3=null;
        ...
        String DesParaQueSirvePB = null,DesParaQueSirvePB1=null,DesParaQueSirvePB2=null;
        ...
        String DesComoVerRutDisp = null,DesComoVerRutDisp1=null;
        ...
        String DesComoSelRutinaC = null,DesComoSelRutinaC1=null,DesComoSelRutinaC2=null,DesComoSelRutinaC3=null,DesComoSelRutinaC4=null;
        ...
        String DesComoSelRutinaZ = null,DesComoSelRutinaZ1=null,DesComoSelRutinaZ2=null,DesComoSelRutinaZ3=null,DesComoSelRutinaZ4=null;
        ...
        String DesSeleccionDispBlue = null,DesSeleccionDispBlue1=null,DesSeleccionDispBlue2=null;
        ...
        //----------------------------------------------------------------------Valores de rutina
        String DesVerificarValRutSel = null,DesVerificarValRutSel1=null,DesVerificarValRutSel2=null;
        ...
        //----------------------------------------------------------------------Mensajes recibidos
        String DesMensajesRecibidos = null,DesMensajesRecibidos1=null,DesMensajesRecibidos2=null,DesMensajesRecibidos3=null,DesMensajesRecibidos4=null,DesMensajesRecibidos5=null,DesMensajesRecibidos6=null;
        ...
        DesMensajesRecibidos2="Este es un mensaje que recibe el móvil cuando la rutina ha comenzado en la máscara, corresponde al presionar el  botón de inicio.";
        DesMensajesRecibidos3="Este es un mensaje que recibe el móvil cuando se ha interrumpido por un momento la rutina y no recibe instrucción de reanudar, la  tarjeta de la máscara activa un segundo temporizador automáticamente antes de finalizar por completo la rutina.";
        DesMensajesRecibidos4="Este es un mensaje que recibe el móvil cuando se ha interrumpido por un momento la rutina y no recibe instrucción de reanudar 2 veces, por lo cual lanzará un mensaje.";
        DesMensajesRecibidos5="Este mensaje aparece después del anterior, solicita una acción para continuar, si el usuario decide esperar, la rutina finalizará inmediatamente, en cambio si reanuda, la rutina continuará.";
        DesMensajesRecibidos6="Este es un mensaje indica que la rutina ha terminado y redirige a selección de rutina.";
        String mensajes[] ={DesMensajesRecibidos,DesMensajesRecibidos1,DesMensajesRecibidos2,DesMensajesRecibidos3,DesMensajesRecibidos4,DesMensajesRecibidos5,DesMensajesRecibidos6};
        ...
        final int[] imagenes16={R.drawable.msg1,R.drawable.msg1,R.drawable.msg2,R.drawable.msg3,R.drawable.msg4,R.drawable.msg5,R.drawable.msg6};//Mensajes recibidos
                ...
                switch (getNumDialogo()){
                    ...
                    case "16":
                        ...
                        if(mPosicion1<mensajes.length-1){
                            ...
                            if(mPosicion1<mensajes.length && getmPosicion1() == 6){
                                cerrar.setVisibility(View.VISIBLE);
                                siguiente.setVisibility(View.GONE);
                            }
                        }
    ...
    private void buscarIDs(){
        ...
        txt = (TextSwitcher) findViewById(R.id.txtTXTm1);
