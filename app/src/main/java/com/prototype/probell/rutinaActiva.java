...
public class rutinaActiva extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Botón de pausa crea una trama que interrumpe momentáneamente la rutina y finalmente la envía
        ...
        //Botón de reanudar crea una trama y la envía
            ...
            switch (caso){
                case 1:
                    new AlertDialog.Builder(this)
                            .setTitle("Aviso")
                            .setMessage("El temporizador de espera expiró, ¿quiere reanudar?")
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Toast.makeText(getApplicationContext(),"El segundo tiempo de espera expiró",Toast.LENGTH_SHORT).show();
                    break;
                case 4: //Fin de rutina
                    ...
                    handler.sendMessage(message);
                    break;
                case 5: //Solicitar retransmisión
                    Toast.makeText(getApplicationContext(),"El primer tiempo de espera expiró",Toast.LENGTH_SHORT).show();
                    break;
